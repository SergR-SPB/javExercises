...
public class Task8_MatrixMaxSumRowFinderExample {
    ...
    //этот метод скопируйте себе в код и вставьте первой строкой в main. Должны получить то, что указано в примере в условии
